...
const itemsData = [
    ...
    { id: generateId(19), name: "Magiczna Fasolka", category: "consumable", slot: null, buy_price_coins: "100", sell_price_coins: "2500", consumable_effect: { "hospital_exit_recovery": true, "restore_hp_pct": 100, "restore_mp_pct": 100, "restore_stamina_pct": 100 } },

    // ==========================================
    // 💰 SAKWY Z MONETAMI (Niesprzedawalne, tylko drop/nagroda)
    // ==========================================
    { id: generateId(20), name: "Mała Sakiewka", category: "consumable", slot: null, buy_price_coins: "22", sell_price_coins: "11", consumable_effect: { "add_coins": "250" } },
    { id: generateId(21), name: "Pękata Sakwa", category: "consumable", slot: null, buy_price_coins: "22", sell_price_coins: "11", consumable_effect: { "add_coins": "500" } },
    { id: generateId(22), name: "Worek Monet", category: "consumable", slot: null, buy_price_coins: "22", sell_price_coins: "11", consumable_effect: { "add_coins": "1000" } },
    { id: generateId(23), name: "Skrzynia Skarbów", category: "consumable", slot: null, buy_price_coins: "22", sell_price_coins: "11", consumable_effect: { "add_coins": "5000" } },
    { id: generateId(24), name: "Królewski Skarbiec", category: "consumable", slot: null, buy_price_coins: "22", sell_price_coins: "11", consumable_effect: { "add_coins": "10000" } },
    ...
    // ==========================================
    // --- SIŁA ---
    { id: generateId(40), name: "Strona Księgi Siły", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "1000", consumable_effect: { "permanent_bonus": { "strength": "100" } } },
    { id: generateId(41), name: "Rozdział Księgi Siły", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "2500", consumable_effect: { "permanent_bonus": { "strength": "250" } } },
    { id: generateId(42), name: "Tomisko Siły", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "5000", consumable_effect: { "permanent_bonus": { "strength": "500" } } },
    { id: generateId(43), name: "Starożytny Tom Siły", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "10000", consumable_effect: { "permanent_bonus": { "strength": "1000" } } },
    // --- SZYBKOŚĆ ---
    { id: generateId(44), name: "Strona Księgi Szybkości", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "1000", consumable_effect: { "permanent_bonus": { "speed": "100" } } },
    { id: generateId(45), name: "Rozdział Księgi Szybkości", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "2500", consumable_effect: { "permanent_bonus": { "speed": "250" } } },
    { id: generateId(46), name: "Tomisko Szybkości", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "5000", consumable_effect: { "permanent_bonus": { "speed": "500" } } },
    { id: generateId(47), name: "Starożytny Tom Szybkości", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "10000", consumable_effect: { "permanent_bonus": { "speed": "1000" } } },
    // --- WYTRZYMAŁOŚĆ ---
    { id: generateId(48), name: "Strona Księgi Wytrzymałości", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "1000", consumable_effect: { "permanent_bonus": { "endurance": "100" } } },
    { id: generateId(49), name: "Rozdział Księgi Wytrz.", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "2500", consumable_effect: { "permanent_bonus": { "endurance": "250" } } },
    { id: generateId(50), name: "Tomisko Wytrzymałości", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "5000", consumable_effect: { "permanent_bonus": { "endurance": "500" } } },
    { id: generateId(51), name: "Starożytny Tom Wytrz.", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "10000", consumable_effect: { "permanent_bonus": { "endurance": "1000" } } },
    // --- INTELIGENCJA ---
    { id: generateId(52), name: "Strona Księgi Inteligencji", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "1000", consumable_effect: { "permanent_bonus": { "intelligence": "100" } } },
    { id: generateId(53), name: "Rozdział Księgi Intel.", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "2500", consumable_effect: { "permanent_bonus": { "intelligence": "250" } } },
    { id: generateId(54), name: "Tomisko Inteligencji", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "5000", consumable_effect: { "permanent_bonus": { "intelligence": "500" } } },
    { id: generateId(55), name: "Starożytny Tom Intel.", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "10000", consumable_effect: { "permanent_bonus": { "intelligence": "1000" } } },
    // --- SIŁA MENTALNA ---
    { id: generateId(56), name: "Strona Księgi Umysłu", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "1000", consumable_effect: { "permanent_bonus": { "mental_strength": "100" } } },
    { id: generateId(57), name: "Rozdział Księgi Umysłu", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "2500", consumable_effect: { "permanent_bonus": { "mental_strength": "250" } } },
    { id: generateId(58), name: "Tomisko Umysłu", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "5000", consumable_effect: { "permanent_bonus": { "mental_strength": "500" } } },
    { id: generateId(59), name: "Starożytny Tom Umysłu", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "10000", consumable_effect: { "permanent_bonus": { "mental_strength": "1000" } } },
    // --- TECHNIKA ---
    { id: generateId(60), name: "Strona Księgi Techniki", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "1000", consumable_effect: { "permanent_bonus": { "technique": "100" } } },
    { id: generateId(61), name: "Rozdział Księgi Techniki", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "2500", consumable_effect: { "permanent_bonus": { "technique": "250" } } },
    { id: generateId(62), name: "Tomisko Techniki", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "5000", consumable_effect: { "permanent_bonus": { "technique": "500" } } },
    { id: generateId(63), name: "Starożytny Tom Techniki", category: "special_consumable", slot: null, buy_price_coins: "22", sell_price_coins: "10000", consumable_effect: { "permanent_bonus": { "technique": "1000" } } },
